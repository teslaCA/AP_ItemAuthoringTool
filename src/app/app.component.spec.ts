...
import {SaItemComponent} from "./item/details/types/sa-item.component/sa-item.component";
import {WerItemComponent} from "./item/details/types/wer-item.component/wer-item.component";
