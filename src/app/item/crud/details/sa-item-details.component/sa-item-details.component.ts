...
@Component({
  selector: 'sa-item-details',
  templateUrl: './sa-item-details.component.html',
  styleUrls: ['./sa-item-details.component.less']
})
export class SaItemDetailsComponent implements OnInit, AfterViewChecked, AfterViewInit {
  //---------------------------------------------------------------------------
  // Stem fields
