...
/**
 * ItemChange model that can be mapped to/from JSON.
 *
...
export class ItemChange {
  @JsonProperty("changedBy", String)
  changedBy: string = undefined;        // Initialize to undefined so that field is mapped
